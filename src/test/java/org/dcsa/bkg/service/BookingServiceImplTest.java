...
class BookingServiceImplTest {
  ...
  class BookingServiceTest {
      ...
      void bookingSummaryRequestWithCarrierBookingRequestReferenceAndDocumentStatusShouldReturnValidBooking() {
          ...
          when(bookingRepository.findAllOrderByBookingRequestDateTime(any(), eq(pageRequest)))
                  .thenReturn(Flux.just(initializeBookingTestInstance(carrierBookingRequestReference, documentStatus, vesselId)));

          when(vesselRepository.findByIdOrEmpty(vesselId)).thenReturn(Mono.just(initializeVesselTestInstance(vesselId)));

          Flux<BookingSummaryTO> bookingToResponse = bookingServiceImpl.getBookingRequestSummaries(carrierBookingRequestReference.toString(), documentStatus, pageRequest);
      ...
      void bookingSummaryRequestWithCarrierBookingRequestReferenceShouldReturnValidBooking() {
          ...
          Flux<BookingSummaryTO> bookingToResponse = bookingServiceImpl.getBookingRequestSummaries(carrierBookingRequestReference.toString(), null, pageRequest);
      ...
      void bookingSummaryRequestWithDocumentStatusShouldReturnValidBooking() {
          ...
          Flux<BookingSummaryTO> bookingToResponse = bookingServiceImpl.getBookingRequestSummaries(null, documentStatus, pageRequest);
      ...
      void bookingSummaryRequestShouldReturnValidBooking() {
          ...
          Flux<BookingSummaryTO> bookingToResponse = bookingServiceImpl.getBookingRequestSummaries(null, null, pageRequest);
